...
internal class CampDownPaymentCommitment internal constructor(
        initialAmount: Money,
        description: String? = null,
        deadlineDate: Instant? = null
) : PaymentCommitment(initialAmount, description, deadlineDate, PaymentCommitmentType.CAMP_DOWN_PAYMENT)