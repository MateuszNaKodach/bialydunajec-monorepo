...
@NoRepositoryBean
abstract class AbstractDomainRepository<AggregateType : AggregateRoot<*, *>, AggregateIdType : AggregateId, RepositoryType: JpaRepository<AggregateType, AggregateIdType>>(
