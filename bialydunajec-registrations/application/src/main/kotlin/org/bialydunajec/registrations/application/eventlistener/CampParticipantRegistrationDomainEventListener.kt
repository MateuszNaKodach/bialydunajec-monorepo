...
internal class CampParticipantRegistrationDomainEventListener(
    ...
    fun handle(event: CampParticipantRegistrationEvent.Created) {
        fun getRegistrationVerificationUrlFor(
            campParticipantRegistrationId: CampParticipantRegistrationId,
        ...
        val emailMessage =
            SimpleEmailMessage(
                ...
                """Cześć ${camperApplication.personalData.firstName},
                            ...
                            ${getRegistrationVerificationUrlFor(
                    event.snapshot.campParticipantRegistrationId,
                    event.snapshot.verificationCode
                )}"""
            )
